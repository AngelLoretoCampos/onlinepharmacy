...
<body class="bg-gray-100">
    <div class="flex justify-between items-center px-4 py-2">
        ...
        <div class="ml-auto flex space-x-4">
            <a href="dashboard.php" class="inline-block bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
    ...
    <div class="bg-white rounded-lg shadow-md mx-auto p-4 max-w-screen-md mt-4">
        ...
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl font-semibold text-green-600">Lyfe Pharmacy (Delivered Orders)</h2>
        </div>
            ...
            <table class="min-w-full table-auto border-collapse border border-gray-300">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='3' class='border px-4 py-2 text-center'>No records with status 'Delivered' found.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
